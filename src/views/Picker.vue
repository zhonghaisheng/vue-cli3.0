  ...
  methods: {
    ...
    chooseItem(value, index) {
      if (this.cacheValueData[index] !== value) {
        ...
        this.updateChooseValue(this, index, value, this.cacheValueData);
      }
    },
    updateChooseValue(self, index, value, cacheValueData) {
      console.log('111', self, index, value, cacheValueData)
      index < 2 && this.updateLinkage(self, value, index + 1, null);
      this.chooseValueData = cacheValueData
    ...
    cancel(){
      ...
      this.pickerShow  = !this.pickerShow
      this.updateLinkage(this, this.cacheValueData[0], 1, this.cacheValueData[1], this.cacheValueData)
    },
    confirm(){// 地区选择器
